...
<div class="container">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner row w-100 mx-auto">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if ($onlineRegistration) { ?>
                                <p class="card-text register"><a href="<?php echo $registrationUrlAdr; ?>"
                                                                 target="_blank"> Register </a></p>
                                <?php
                            } else { ?>
                                <p class="card-text register"> Online Registration Not Available <a
                                            href="<?php echo $registrationUrlAdr; ?>" target="_blank"> More Info </a>
                                </p>
                                <?php
                            }
                            ?>
            ...
            </div> <!-- end div carousel-inner row w-100 mx-auto-->
                    ...
                    <tr class="delete_mem<?php echo $event['id']; ?>">
                        ...
                        <td>
                            <form action="?controller=dynamic&action=editEvent" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary" name="edit_event_btn"
                                        id="<?php echo $event['eventId']; ?>">Edit
                                </button>
                            </form>
                        </td>

                        <td>
                            <form action="?controller=dynamic&action=user_events" method="post">
                                <input type="hidden" name="action"
                                       value="delete_event">
                                ...
                                <button type="submit" class="btn btn-danger" id="<?php echo $event['eventId']; ?>">
                                    Delete
                                </button>
                            </form>
                        </td>
